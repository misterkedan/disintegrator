...
class TextureComputer {
	...
	constructor(
		...
		if ( ! TextureComputer.renderer ) throw new Error(
			'Use TextureComputer.init( renderer ) before instancing.'
		);
...
TextureComputer.render = ( material, renderTarget ) => {
	...
	TextureComputer.renderer.render( TextureComputer.scene, TextureComputer.camera );
...
TextureComputer.createRenderTarget = ( size ) => new WebGLRenderTarget(
	size,
	size,
	{
